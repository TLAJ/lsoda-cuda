...
int dlsoda_(Fex f, int *neq, double *y, double *t, double *tout, int *itol, double *rtol, double *atol, int *itask, int *istate, int *iopt, double *rwork, int *lrw, int *iwork, int *liw, Jex jac, int *jt, struct cuLsodaCommonBlock *common, double *param)
{
    /* Initialized data */
...
/* DECK DCFODE */
/* Subroutine */ 
int dcfode_(int PARAM_meth, double *DCFODE_elco, double *DCFODE_tesco, struct cuLsodaCommonBlock *common)
{
    /* System generated locals */
    int i__1 = 0;
...
/* DECK XSETF */
/* Subroutine */ 
//int xsetf_(int *mflag, struct cuLsodaCommonBlock *common)
//{
//     int junk;
...
/* DECK XSETUN */
/* Subroutine */ 
//int xsetun_(int *lun, struct cuLsodaCommonBlock *common)
//{
//     int junk;
